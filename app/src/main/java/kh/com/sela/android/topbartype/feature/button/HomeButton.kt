package kh.com.sela.android.topbartype.feature.button
...
val scrollState = rememberScrollState()
    val lsItem= listOf(NavigationBarItem(label = "Home", icon = drawable.ic_home ),
        NavigationBarItem(label = "Video", icon = drawable.ic_qr ,),
        NavigationBarItem(label = "Profile", icon = drawable.ic_profile ,)
    )
